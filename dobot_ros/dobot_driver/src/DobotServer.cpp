...
void InitPTPServices(ros::NodeHandle &n, std::vector<ros::ServiceServer> &serverVec)
{
    ...
    server = n.advertiseService("SetPTPJointParams", SetPTPJointParamsService);
    serverVec.push_back(server);
    server = n.advertiseService("GetPTPJointParams", GetPTPJointParamsService);
    serverVec.push_back(server);
    server = n.advertiseService("SetPTPCoordinateParams", SetPTPCoordinateParamsService);
    serverVec.push_back(server);
    server = n.advertiseService("GetPTPCoordinateParams", GetPTPCoordinateParamsService);
    serverVec.push_back(server);
    server = n.advertiseService("SetPTPJumpParams", SetPTPJumpParamsService);
    serverVec.push_back(server);
    server = n.advertiseService("GetPTPJumpParams", GetPTPJumpParamsService);
    serverVec.push_back(server);
    server = n.advertiseService("SetPTPCommonParams", SetPTPCommonParamsService);
    serverVec.push_back(server);
    server = n.advertiseService("GetPTPCommonParams", GetPTPCommonParamsService);
    serverVec.push_back(server);
...
void InitCPServices(ros::NodeHandle &n, std::vector<ros::ServiceServer> &serverVec)
{
    ...
    server = n.advertiseService("SetCPParams", SetCPParamsService);
    serverVec.push_back(server);
    server = n.advertiseService("GetCPParams", GetCPParamsService);
    serverVec.push_back(server);
    server = n.advertiseService("SetCPCmd", SetCPCmdService);
    serverVec.push_back(server);
}
...
void InitARCServices(ros::NodeHandle &n, std::vector<ros::ServiceServer> &serverVec)
{
    ...
    server = n.advertiseService("SetARCParams", SetARCParamsService);
    serverVec.push_back(server);
    server = n.advertiseService("GetARCParams", GetARCParamsService);
    serverVec.push_back(server);
    server = n.advertiseService("SetARCCmd", SetARCCmdService);
    serverVec.push_back(server);
}
...
void InitWAITServices(ros::NodeHandle &n, std::vector<ros::ServiceServer> &serverVec)
{
    ...
    server = n.advertiseService("SetWAITCmd", SetWAITCmdService);
    serverVec.push_back(server);
}
...
void InitTRIGServices(ros::NodeHandle &n, std::vector<ros::ServiceServer> &serverVec)
{
    ...
    server = n.advertiseService("SetTRIGCmd", SetTRIGCmdService);
    serverVec.push_back(server);
}
...
void InitEIOServices(ros::NodeHandle &n, std::vector<ros::ServiceServer> &serverVec)
{
    ...
    server = n.advertiseService("SetIOMultiplexing", SetIOMultiplexingService);
    serverVec.push_back(server);
    server = n.advertiseService("GetIOMultiplexing", GetIOMultiplexingService);
    serverVec.push_back(server);
    server = n.advertiseService("SetIODO", SetIODOService);
    serverVec.push_back(server);
    server = n.advertiseService("GetIODO", GetIODOService);
    serverVec.push_back(server);
    server = n.advertiseService("SetIOPWM", SetIOPWMService);
    serverVec.push_back(server);
    server = n.advertiseService("GetIOPWM", GetIOPWMService);
    serverVec.push_back(server);
    server = n.advertiseService("GetIODI", GetIODIService);
    serverVec.push_back(server);
    server = n.advertiseService("GetIOADC", GetIOADCService);
    serverVec.push_back(server);
    server = n.advertiseService("SetEMotor", SetEMotorService);
    serverVec.push_back(server);
}
...
void InitQueuedCmdServices(ros::NodeHandle &n, std::vector<ros::ServiceServer> &serverVec)
{
    ...
    server = n.advertiseService("SetQueuedCmdStartExec", SetQueuedCmdStartExecService);
    serverVec.push_back(server);
    server = n.advertiseService("SetQueuedCmdStopExec", SetQueuedCmdStopExecService);
    serverVec.push_back(server);
    server = n.advertiseService("SetQueuedCmdForceStopExec", SetQueuedCmdForceStopExecService);
    serverVec.push_back(server);
    server = n.advertiseService("SetQueuedCmdClear", SetQueuedCmdClearService);
    serverVec.push_back(server);
}
